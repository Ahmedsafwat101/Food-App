...
public class MainActivity extends AppCompatActivity {
     RecyclerView RCV;
     RecipeRecyclerView myRCVAdapter;
     List<Recipes>recipesData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipesData.add(new Recipes("Chicken Roll","200 gm chopped into cubes chicken" +"\n"+
                ...
                "Chicken Roll is a delectable North Indian recipe made using all purpose flour,stir-fried chicken, yoghurt and a variety of vegetables rolled into paranthas.\nOn days you do not want to prepare an elaborate meal, this delectable dish can be a saviour.\nRolls are quite popular across India and they are often a favourite evening snack.\n Egg Roll, Kathi Kebab Roll, Mutton Roll, Paneer Roll, Potato Roll and even Fish Roll are among its many variations.\n This easy roll recipe is made using chicken and has the unforgettable aroma of Indian spices. You can also utilize your leftover parathas and chapatis in making this recipe. If you do not like to use all-purpose flour or maida, you can make it with whole wheat flour too. \n In fact, it can be made even with leftover chicken.\n All you have to ensure is that you use the right amount of spices so that the flavour is not lost. Easy to pack and carry, you can also take it to office or prepare it for picnics and day trips.\n A must try roll recipe for all chicken lovers!\n",R.drawable.chicken_roll));

        recipesData.add(new Recipes("Donut","1 c. whole milk"+"\n"+
                ...
                "Grease a large bowl with cooking spray and set aside. \n In a small, microwave-safe bowl or glass measuring cup, add milk.\n Microwave until lukewarm, 40 seconds.\n Add a teaspoon of sugar and stir to dissolve, then sprinkle over yeast and let sit until frothy, about 8 minutes.\n" +
                "Make glaze: In a large bowl, whisk together milk, powdered sugar, and vanilla until smooth. \n Set aside.\n"+
                "Line a large baking sheet with paper towels.\n In a large dutch oven over medium heat, heat 2'' oil to 350°. Cook doughnuts, in batches, until deeply golden on both sides, about 1 minute per side. \nHoles will cook even faster!\n" +
                "Transfer doughnuts to paper towel-lined baking sheet to drain and cool slightly.\n Dip into glaze, then place onto a cooling rack (or eat immediately!)",R.drawable.donut1));
        recipesData.add(new Recipes("Dosa","3 cups rice" +
                "1 cup urad daal (split, skinless black gram)" +"\n"+
                "3/4 teaspoon fenugreek seeds" +"\n"+
                "Salt (to taste)" +"\n"+
                "Vegetable / canola / sunflower cooking oil","Method",
                "Wash the rice and urad daal well.\n Add the fenugreek seeds to the mix and fill enough water in the rice-daal bowl to cover them about 2-inch deep. Soak overnight.\n" +
        ...
        recipesData.add(new Recipes("Pancake","1 1/4 cups milk" +"\n"+
                ...
                "In a large bowl, sift together the flour, baking powder, salt and sugar. +\n+Make a well in the center and pour in the milk, egg and melted butter; mix until smooth." +
                        "Heat a lightly oiled griddle or frying pan over medium high heat.+\n+ Pour or scoop the batter onto the griddle, using approximately 1/4 cup for each pancake. +\n+Brown on both sides and serve hot.",R.drawable.pancakes));
        recipesData.add(new Recipes("Pasta","1 tsp oil" +"\n"+
                "1 tsp butter" +"\n"+
        ...
        myRCVAdapter = new RecipeRecyclerView(this,recipesData);
